...
async def get_claude_code_response_async(
    ...
    question: Question,
    chat_history: str,
    embedding_folder_list: List[str],
        ...
        async def consume():
            try:
                agen = get_claude_code_response_async(
                    chat_session, file_path_list, question, chat_history, embedding_folder_list, deep_thinking, stream
                )
    ...
    for i, question in enumerate(test_questions, 1):
        ...
        try:
            response_generator = get_claude_code_response(
                ...
                embedding_folder_list=[codebase_dir],
                deep_thinking=True,
                stream=True,
            )
